    ...
    <MaxWidthWrap className="w-full p-8 relative z-50">
      <nav className="flex justify-between items-center">
        ...
        <div
          ...
          ${
            showMobileNav
              ...
              : "max-md:translate-x-full pointer-events-none"
          }
        ...
        >
          ...
          <Button
            className="md:hidden bg-white text-black hover:bg-white/80 cursor-pointer mt-4"
            asChild
          >
        ...
        <Button
          className="max-md:hidden bg-white text-black hover:bg-white/80 cursor-pointer"
          asChild
        >
          <Link href="/wallet-connect">Connect Wallet</Link>
        </Button>
